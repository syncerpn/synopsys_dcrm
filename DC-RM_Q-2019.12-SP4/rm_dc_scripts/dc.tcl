...
if {$ICC2LINK_FLOW == TRUE || $NDM_FLOW == TRUE} {
### DCNXT ICC2link flow is recommended for 7nm and lower node for better timing & congestion correlation with ICC2
### Set ICC2link related option using “set_icc2_options” command.
### For MW mode, it is recommended to use “-congestion_use_global_route true” with ICC2link flow. This option is not required for NDM based flow.
set_icc2_options -technology $TECH_FILE -ref_libs $NDM_REFERENCE_LIB_DIRS  -congestion_use_global_route true
### Please specify node name using “set_technology” command.
set_technology -node “$NODE”

### Turn on Auto timing control setting for timing critical design
set_app_var placer_auto_timing_control true

### Enable this feature for buffering aware timing driven placement
set_app_var placer_buffering_aware true

### Enable this feature for congestion driven restructuring  to improve congestion
