...
set TARGET_LIBRARY_FILES          ""  ;#  Target technology logical libraries (used by DC, DCCNT)
set ADDITIONAL_LINK_LIB_FILES     ""  ;#  Extra link logical libraries not included in TARGET_LIBRARY_FILES (used by DC, DCNXT)
...
set TECH_FILE                     ""  ;#  Milkyway technology file (used by DC, DCNXT)
set NDM_REFERENCE_LIB_DIRS        ""  ;#  NDM Reference Library (used by DCNXT)
set MAP_FILE                      ""  ;#  Mapping file for TLUplus  (used by DC, DCNXT)
set TLUPLUS_MAX_FILE              ""  ;#  Max TLUplus file  (used by DC, DCNXT)
set TLUPLUS_MIN_FILE              ""  ;#  Min TLUplus file  (used by DC, DCNXT)

set MIN_ROUTING_LAYER            ""   ;# Min routing layer (used by DC, DCNXT)
set MAX_ROUTING_LAYER            ""   ;# Max routing layer (used by DC, DCNXT)
