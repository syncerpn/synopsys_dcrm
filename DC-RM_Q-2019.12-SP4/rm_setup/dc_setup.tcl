...
## Set the varible to TRUE if ICC2 LINK is being used in the flow. { TRUE FALSE }
set ICC2LINK_FLOW "" 

## Set the varible to TRUE to enable NDM Flow in DCNXT. { TRUE FALSE }
set NDM_FLOW ""
...
if {$synopsys_program_name == "dc_shell" || $synopsys_program_name == "dcnxt_shell"}  {
  ...
  if {$NDM_FLOW == TRUE} {
   if {[shell_is_dcnxt_shell]} {   
   create_lib -technology ${TECH_FILE} -ref_libs $ndm_reference_library $ndm_design_library
   }
  }
  } else {
