...
proc BuildSelectWidget::buttonRun {} {
  ...
  # for now, status and signoff are only available in the TCL version of the scripts
  set scriptToUse(Status)                    $script_dir/../flow_reports_tcl/gen_status.tcl
  set scriptToUse(Signoff)                   $script_dir/../flow_reports_tcl/gen_signoff.tcl
