...
#################################################################################
    ...
    # option at the compile_ultra command. To prevent XOR self-gating on 
    # clock-gated registers, uncomment the following line:
    # set_self_gating_options -interaction_with_clock_gating none
